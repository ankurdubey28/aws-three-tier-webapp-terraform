...
output "helpful_commands" {
  ...
  value       = <<-EOT
    ...
    ═══════════════════════════════════════════════════════════════════
                    Feedback Collector Infrastructure - Dev
    ═══════════════════════════════════════════════════════════════════
    ...
    🗄️  Database:
       Endpoint is available from the sensitive db_endpoint output.
       Password is generated by random_password.db_password in Terraform state.
