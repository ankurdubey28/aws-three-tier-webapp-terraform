...
locals {
  database_url = "postgres://${var.db_username}:${random_password.db_password.result}@${module.rds.db_endpoint}/${var.db_name}?sslmode=disable"
}
